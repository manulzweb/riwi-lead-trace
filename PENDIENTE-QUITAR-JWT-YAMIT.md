...
### 1. `backend/app/schemas/auth.py`  HECHO
...
### 2. `backend/app/services/auth_service.py` HECHO
...
### 3. `backend/app/schemas/evaluation.py` HECHO
...
### 4. `backend/app/services/evaluation_service.py` PENDIENTE
...
### 5. `backend/app/routes/evaluation_routes.py` HECHO
...
### 6. `backend/app/routes/form_routes.py` HECHO
...
### 7. `backend/app/routes/period_routes.py` HECHO
...
### 8. `backend/app/routes/user_routes.py` HECHO
...
### 9. `backend/app/routes/metrics_routes.py` HECHO
...
### 10. `backend/app/deps.py` y `backend/app/config/security.py` HECHO (comente el codigo de los dos scripts)
...
### 11. `frontend/src/services/auth.service.js` HECHO
...
### 12. `frontend/src/services/api.service.js` HECHO
...
### 13. `frontend/src/views/auth/login.js` HECHO
...
### 14. `frontend/src/views/coder/evaluate.view.js` HECHO
